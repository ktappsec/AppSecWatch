...
Used by `appsecwatch verify-deps` (CLI) and can be called from anywhere that
...
from appsecwatch.util.subproc import run_tool, tool_version
...
async def run_preflight(cfg: AppSecWatchConfig | None = None) -> PreflightReport:
